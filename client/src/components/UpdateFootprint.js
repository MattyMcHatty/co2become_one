...
const UpdateFootprint = ({footprints, _id}) => {
...
<form onSubmit={onSubmit} id="footprint-form">
            ...
            <div className="form-wrap">
                ...
                <input onChange={onChange} type="text"  value={footprint[0].username}  required />
            </div>
            <div className="form-wrap">
                <label htmlFor="household">How many people live in your house?: </label>
                <select onChange={onChange} id="household" name="household"  required>
            ...
            <div className="form-wrap">
                ...
                <select onChange={onChange} id="house_size" name="house_size" required>
                    {/* <option value="" default >Please Select</option> */}
            ...
            <div className="form-wrap">
                ...
                <select onChange={onChange} id="food" name="food"  required>
                    {/* <option value="" default >Please Select</option> */}
            ...
            <div className="form-wrap">
                ...
                <select onChange={onChange} id="water" name="water"  required>
                    {/* <option value="" default >Please Select</option> */}
            ...
            <div className="form-wrap">
                ...
                <select onChange={onChange} id="purchases" name="purchases"  required>
                    {/* <option value="" default >Please Select</option> */}
            ...
            <div className="form-wrap">
                ...
                <select onChange={onChange} id="waste" name="waste"  required>
                    {/* <option value="" default >Please Select</option> */}
            ...
            <div className="form-wrap">
                ...
                <select onChange={onChange} id="transport" name="transport"  required>
                    {/* <option value="" default >Please Select</option> */}
            ...
            <div className="form-wrap">
                ...
                <select onChange={onChange} id="recycle" name="recycle"  required>
